...
const OrderModal = ({ item, stall, onClose, onConfirm, walletPoints }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-[fadeIn_0.2s_ease-out]">
      <div className="bg-[#0c0d21] border border-white/10 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-[slideUp_0.3s_ease-out]">
        ...
        <div className="p-6 pt-14">
          <div className="mb-6">
            <span className="text-cyan-400 text-sm font-bold uppercase tracking-wider">{stall.name}</span>
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="flex-1 bg-white/5 border border-white/5 rounded-xl p-4 flex flex-col items-center justify-center">
              ...
              <span className="text-xl font-bold text-blue-500">{item.pointsCost} pts</span>
            </div>
            <div className="flex-1 bg-white/5 border border-white/5 rounded-xl p-4 flex flex-col items-center justify-center">
          ...
          <div className="border-t border-white/10 pt-6">
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition ${
                ...
                ? 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-500 hover:to-blue-600 text-white shadow-lg shadow-cyan-500/25' 
