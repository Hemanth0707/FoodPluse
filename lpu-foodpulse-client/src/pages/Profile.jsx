...
const Profile = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 pb-24 lg:pb-12 space-y-8 animate-[fadeUp_0.4s_both] selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div 
            ...
            className="fixed top-6 left-1/2 z-50 bg-[#151515]/90 border border-amber-500/30 text-white px-5 py-3 rounded-2xl flex items-center gap-2.5 shadow-2xl backdrop-blur-md text-xs font-bold"
          >
      ...
      <div className="relative rounded-[2.5rem] p-8 md:p-10 bg-white/[0.02] border border-white/5 shadow-2xl overflow-hidden backdrop-blur-3xl">
        <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[#151515] rounded-full blur-[80px] pointer-events-none" />
        
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          {/* Left Side: Avatar + Details */}
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            {/* Circular Avatar */}
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-amber-600 to-yellow-500 text-neutral-950 p-0.5 shadow-[0_0_20px_rgba(198, 138, 43, 0.2)] shrink-0">
              <div className="w-full h-full rounded-full overflow-hidden bg-[#0B0B0B] flex items-center justify-center">
                <span className="text-3xl font-display font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-200">
            ...
            <div className="space-y-3">
              <div className="flex flex-col sm:flex-row sm:items-center justify-center md:justify-start gap-2">
                ...
                <div className="flex items-center justify-center gap-2 shrink-0">
                  <span className="px-2.5 py-0.5 rounded-lg text-[9px] font-bold uppercase tracking-wider border border-amber-500/20 bg-amber-500/5 text-amber-500">
                    Level 4
                  </span>
                  <span className="flex items-center gap-1 text-[10px] text-[#7BA05B] font-bold bg-green-500/10 border border-green-500/20 px-2 py-0.5 rounded-lg">
          ...
          <button 
            ...
            className="px-5 py-3 rounded-xl border border-white/10 hover:border-amber-500/30 bg-white/5 text-white text-xs font-bold transition-all flex items-center gap-1.5 hover:bg-white/10 shrink-0 cursor-pointer"
          >
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <button 
            ...
            className="group relative overflow-hidden border border-white/5 hover:border-amber-500/30 bg-white/[0.01] hover:bg-white/[0.03] rounded-2xl p-5 flex items-center gap-4 transition-all duration-300 text-left cursor-pointer"
          >
            <div className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/20 text-amber-500 group-hover:scale-105 transition-transform">
              <ShoppingBag size={20} />
            </div>
            <div>
          ...
          >
            <div className="p-3 rounded-xl bg-yellow-500/3 border border-blue-600/20 text-amber-500 group-hover:scale-105 transition-transform">
          ...
          >
            <div className="p-3 rounded-xl bg-amber-500/5 border border-blue-500/20 text-amber-500 group-hover:scale-105 transition-transform">
              <Bell size={20} />
            </div>
            <div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <button 
            ...
            className="text-xs font-bold text-amber-500 hover:text-amber-500 flex items-center gap-0.5 transition-colors cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-5 flex items-center gap-4 relative overflow-hidden">
            <div className="w-11 h-11 rounded-xl bg-amber-500/5 text-amber-500 flex items-center justify-center shadow-inner">
              <Wallet size={18} />
            </div>
            <div>
          ...
          {/* Card 2 */}
          <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-5 flex items-center gap-4 relative overflow-hidden">
            <div className="w-11 h-11 rounded-xl bg-yellow-500/3 text-amber-500 flex items-center justify-center shadow-inner">
              <ShoppingBag size={18} />
            </div>
            <div>
          ...
          {/* Card 3 */}
          <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-5 flex items-center gap-4 relative overflow-hidden">
            <div className="w-11 h-11 rounded-xl bg-green-500/10 text-[#7BA05B] flex items-center justify-center shadow-inner">
              <TrendingUp size={18} />
            </div>
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="p-6 bg-white/[0.02] border border-white/5 rounded-[2rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl flex flex-col justify-between min-h-[460px]">
          <div>
            <h3 className="text-base font-display font-extrabold text-white tracking-tight mb-5 flex items-center gap-2 border-b border-white/5 pb-3">
              <ShoppingBag size={16} className="text-amber-500" /> Food Activity
            </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="p-4 bg-white/5 border border-white/5 rounded-2xl flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#151515] border border-amber-500/20 flex items-center justify-center text-2xl shrink-0">
                    🍔
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-white">Spicy Veg Burger</h4>
                    <p className="text-[10px] text-amber-500 font-semibold mt-0.5">Ordered 14 times</p>
              ...
              <div className="space-y-2.5">
                ...
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-3 bg-white/[0.01] border border-white/5 rounded-xl hover:bg-white/[0.02] transition-all">
                    ...
                    <span className="text-[10px] font-extrabold text-amber-500">{item.price}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <button 
            ...
            className="w-full py-2.5 mt-5 border border-white/5 hover:border-amber-500/20 bg-white/5 hover:bg-white/10 rounded-xl text-[10px] font-bold uppercase tracking-wider text-gray-300 hover:text-white transition-all flex items-center justify-center gap-1 cursor-pointer"
          >
        ...
        <div className="p-6 bg-white/[0.02] border border-white/5 rounded-[2rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl flex flex-col justify-between min-h-[460px]">
          <div>
            <h3 className="text-base font-display font-extrabold text-white tracking-tight mb-5 flex items-center gap-2 border-b border-white/5 pb-3">
              <AlertTriangle size={16} className="text-amber-500" /> Issue Reports
            </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-5 bg-white/5 border border-white/5 p-4 rounded-2xl">
                ...
                <div className="relative w-12 h-12 flex items-center justify-center shrink-0">
                  <svg className="w-full h-full text-amber-500 transform -rotate-90" viewBox="0 0 36 36">
                    ...
                    <path className="text-amber-500" strokeDasharray="85, 100" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                  </svg>
              ...
              <div className="grid grid-cols-3 gap-2.5 text-center">
                ...
                <div className="bg-green-500/10 border border-green-500/20 p-2.5 rounded-xl">
                  <span className="text-[18px] font-extrabold text-[#7BA05B] block">10</span>
                  <span className="text-[8px] text-[#7BA05B] font-bold uppercase tracking-wider">Resolved</span>
                </div>
              ...
              <div className="space-y-2">
                {[
                  { name: 'Bad Taste', status: 'Resolved', time: 'Today, 10:30 AM', color: 'bg-green-500/20 text-[#7BA05B] border-green-500/20' },
                  { name: 'Stale Food', status: 'Resolved', time: '10 May, 3:45 PM', color: 'bg-green-500/20 text-[#7BA05B] border-green-500/20' },
          ...
          <div>
            <div className="flex justify-between items-center mb-5 border-b border-white/5 pb-3">
              ...
              <button 
                ...
                className="text-[10px] font-bold text-amber-500 hover:text-amber-500 transition-colors"
              >
                View All
              </button>
            </div>
      ...
      <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[2rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-display font-extrabold text-white tracking-tight flex items-center gap-2">
            <History className="text-amber-500" /> Points Transaction History
          </h3>
          <button 
            onClick={() => navigate('/wallet')} 
            className="text-xs font-bold text-amber-500 hover:text-amber-500 flex items-center gap-0.5 transition-colors cursor-pointer"
        ...
        <div className="overflow-x-auto w-full border border-white/5 rounded-2xl bg-black/20 hide-scrollbar">
          <table className="w-full text-left text-xs border-collapse min-w-[500px]">
            <thead>
              <tr className="border-b border-white/5 bg-[#0B0B0B] text-gray-500 font-bold uppercase tracking-wider text-[10px]">
            ...
            <tbody>
              {PointHistoryData.map((txn, idx) => (
                <tr key={idx} className="border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className={`py-4 px-6 text-right font-display font-extrabold text-sm ${txn.type === 'earn' ? 'text-[#7BA05B]' : 'text-amber-500'}`}>
                    {txn.points}
                  </td>
                </tr>
              ))}
      ...
      <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[2.5rem] shadow-2xl relative overflow-hidden backdrop-blur-3xl">
        <div className="absolute top-0 left-0 w-32 h-32 bg-amber-500/2 rounded-full blur-2xl pointer-events-none" />
        
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
          {/* Left Input Details */}
          <div className="md:col-span-7 space-y-6">
            <div className="space-y-2">
              <span className="text-[10px] bg-amber-500/5 text-amber-500 font-bold px-2.5 py-1 rounded-full border border-amber-500/20 uppercase tracking-widest inline-block">
                Referral Program
              </span>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-3 max-w-sm">
                  <div className="flex-1 bg-[#151515]/60 border border-white/10 rounded-2xl py-3.5 px-4 text-white text-sm font-mono font-extrabold shadow-inner flex items-center justify-between">
                    ...
                    <button 
                      ...
                      title="Copy Code"
                    >
                      {copied ? <Check size={16} className="text-[#7BA05B]" /> : <Copy size={16} />}
                    </button>
                  </div>
                  
                  <button 
                    onClick={() => triggerToast('Referral invite link generated!')}
                    className="px-6 py-3.5 rounded-2xl bg-gradient-to-tr from-amber-600 to-yellow-500 text-neutral-950 hover:scale-[1.02] text-white font-bold text-xs shadow-lg transition-all cursor-pointer"
                  >
                    Invite Now
                  </button>
                </div>
          ...
          <div className="md:col-span-5 flex justify-center">
            <svg viewBox="0 0 280 200" className="w-full max-w-[280px] drop-shadow-[0_0_30px_rgba(198, 138, 43, 0.1)]">
              <defs>
                <linearGradient id="goldCream" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#C68A2B" stopOpacity="0.3" />
                  <stop offset="100%" stopColor="#ECE6DD" stopOpacity="0.05" />
                </linearGradient>
                <linearGradient id="glowG" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#C68A2B" />
                  <stop offset="100%" stopColor="#ECE6DD" />
                </linearGradient>
              </defs>
              
              {/* Background Shapes */}
              <rect x="20" y="20" width="240" height="160" rx="20" fill="url(#goldCream)" stroke="rgba(255,255,255,0.05)" strokeWidth="1" />
              
              {/* Connecting Nodes */}
              <circle cx="90" cy="100" r="25" fill="#020208" stroke="rgba(198, 138, 43, 0.2)" strokeWidth="1.5" />
              <circle cx="190" cy="100" r="25" fill="#020208" stroke="rgba(198, 138, 43, 0.2)" strokeWidth="1.5" />
